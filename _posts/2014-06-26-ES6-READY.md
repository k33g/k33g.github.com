...
layout: post
title: Get ready for Ecmascript6
info : Get ready for Ecmascript6

---

#Get ready for Ecmascript6
...
Create a `models` directory in `publix/js/app` with two new javascript files inside : `human.js` ans `humans.js` :
