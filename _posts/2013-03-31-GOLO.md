...
##Golo et Java, utiliser les fonctionnalités de bases

###Exemple : Les Strings & co

Alors de fait vous les utilisez dans Golo : `var hello = "hello world !"` mais aussi avec les objets dans Golo qui "portent" les primitivents de base :
